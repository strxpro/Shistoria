...
window.I18N = {
  it: {
    ...
    ristorante: {
      ...
      chefTitle: "Chef's Table",
      chefText: "Otto coperti, un tavolo, una sera. Lo chef cucina davanti a voi, racconta i piatti, condivide la storia di ogni ingrediente. Disponibile su prenotazione.",
  ...
  pl: {
    ...
    ristorante: {
      ...
      chefTitle: "Chef's Table",
      chefText: "Osiem miejsc, jeden stół, jeden wieczór. Szef kuchni gotuje na Twoich oczach, opowiada o daniach. Tylko na rezerwację.",
  ...
  en: {
    ...
    ristorante: {
      ...
      chefTitle: "Chef's Table",
      chefText: "Eight seats, one table, one evening. The chef cooks in front of you, tells the story of each dish. By reservation only.",
      cta: "See full menu",
  ...
  de: {
    ...
    ristorante: {
      ...
      chefTitle: "Chef's Table",
      chefText: "Acht Plätze, ein Tisch, ein Abend. Der Küchenchef kocht vor Ihnen und erzählt die Geschichte jedes Gerichts. Nur mit Reservierung.",
  ...
  fr: {
    ...
    ristorante: {
      ...
      chefTitle: "Chef's Table",
      chefText: "Huit places, une table, une soirée. Le chef cuisine devant vous, raconte l'histoire de chaque plat. Sur réservation uniquement.",
  ...
  es: {
    ...
    ristorante: {
      ...
      chefTitle: "Chef's Table",
      chefText: "Ocho asientos, una mesa, una noche. El chef cocina frente a ti, cuenta la historia de cada plato. Solo con reserva.",
